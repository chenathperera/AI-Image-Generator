...
const MainDash = ({ activeTab, selectedStyle, setSelectedStyle }) => {
  ...
  // FIX: Clear the generated image whenever a new style is selected or category changes
  useEffect(() => {
    setGeneratedImg(null); // This removes the old photo when switching items
      ...
      <div className='bg-[#F8F9FA] rounded-[32px] p-8 min-h-full relative'>
        ...
        <div className='flex flex-col lg:flex-row gap-12'>
          ...
          <div className='lg:w-[40%]'>
            ...
            {!generatedImg ? (
              <button 
                onClick={() => setGeneratedImg(mainImage)} // Simulate generation
              ...
              <div className='space-y-6 animate-in slide-in-from-bottom-4 duration-500'>
                ...
                <div className='flex gap-4'>
                  ...
                  <button className='flex-1 bg-black text-white py-3 rounded-xl font-bold hover:opacity-90 transition-opacity'>
                    Download
                  </button>
                </div>
              </div>
